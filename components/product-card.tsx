...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden hover-lift bg-card border-border h-full">
        ...
        <CardContent className="p-4">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              className="flex-1 group/btn border-primary/50 hover:bg-primary/10 pointer-events-none"
              tabIndex={-1}
            >
